...
if not (
    os.getenv("DATABASE_URL") and os.getenv("NEO4J_URI") and os.getenv("NEO4J_PASSWORD")
):
    pytest.skip("Ambiente cloud non configurato: DATABASE_URL/NEO4J_URI/NEO4J_PASSWORD mancanti", allow_module_level=True)
